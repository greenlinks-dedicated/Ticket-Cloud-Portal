...
@Component({
  selector: 'app-View_Events',
  templateUrl: './View_Events.component.html',
  styleUrls: ['./View_Events.component.css']
})
export class View_EventsComponent implements OnInit {
  ...
  /*
    ngAfterViewInit() {
      ...
      const table = $('#datatables').data();  // Datatable
  ...
  */
  ...
  editEvent() {
    this.router.navigate(['/events/editevent'])
  }

  gotoEventInfo() {
    this.router.navigate(['/events/eventinfo'])
  }
